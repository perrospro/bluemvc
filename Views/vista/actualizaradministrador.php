...
<div class="container" style="width: 50%;">
	<h2>Actualizar Informacion administradores</h2>
	<form action="?controller=persona&&action=updateadministrador" method="POST">
	<input type="hidden" name="idusuario" value="<?php echo $persona->getIdusuario() ?>" >
      ...
      <input type="text" class="form-control" id="telefono" placeholder="Ingrese el numero celular" name="telefono" value="<?php echo $persona->getTelefono() ?>"  required>

      <input type="hidden" class="form-control" id="reconpensa" placeholder="Ingrese la descripcion" name="reconpensa" value="<?php echo $persona->getReconpensa() ?>"  required>
    </div>
    <br>
