...
<div class="container" style="width: 50%;">
  ...
  <form action="?controller=persona&&action=saveadministrador" method="POST">
    ...
    <button type="submit" class="btn btn-outline-primary"">crear</button> <a style="padding:10px ;"  class="btn btn-outline-info" href="?controller=persona&&action=showoadministrador">Regresar</a>
